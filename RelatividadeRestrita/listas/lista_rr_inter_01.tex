...
\begin{enumerate}
      \item Quadrivelocidade e tempo próprio: Seja $x^\mu(\tau)$ a trajetória de uma
            partícula parametrizada pelo seu tempo próprio $\tau$.

            \begin{enumerate}
                  \item Defina a quadrivelocidade por
                        $$
                              u^\mu \equiv \frac{1}{c}\frac{\mathrm{d}x^\mu}{\mathrm{d}\tau}.
                        $$

                        Mostre que $u^\mu$ transforma-se como um quadrivetor sob
      ...
      \item Quadriaceleração:

            \begin{enumerate}
                  \item Defina a quadriaceleração por
                        $$
      ...
      \item Quadrimomento:
            ...
            \begin{enumerate}
                  \item Defina o quadrimomento por
                        $$
                              p^\mu\equiv mc\,u^\mu.
                        $$
      ...
      \item Quadrivetor de onda e efeito Doppler:

            \begin{enumerate}
                  \item Considere uma onda plana cuja fase é dada por
                        $$
                              \phi=k_\mu x^\mu.
                        $$
      ...
      \item Quadripotencial eletromagnético:

            \begin{enumerate}
                  \item Defina o quadripotencial
                        $$
                              A^\mu=
                              \left(
                              \frac{\phi}{c},
      ...
      \item Equações de Maxwell com fontes:

            \begin{enumerate}
                  \item Defina a quadricorrente
                        $$
                              J^\mu=(c\rho,\mathbf J).
                        $$
      ...
      \item Equações homogêneas de Maxwell:

            \begin{enumerate}
                  \item Defina o tensor dual
                        $$
                              \widetilde F^{\mu\nu}
                              =
                              \frac12
